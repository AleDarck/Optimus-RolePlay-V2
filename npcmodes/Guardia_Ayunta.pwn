#define RECORDING "Guardia_Ayunta" //Aqui ponemos el nombre del arvhivo que grabaste, Ejemplo: vendedor
#define RECORDING_TYPE 2  //Aqui va 1 tu NPC es en vehículo, 2 si es a pie
